  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-5 text-white shadow-lg">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="font-medium leading-relaxed text-sm">{tip.replace(/\*\*/g, '').replace(/\*/g, '').replace(/^#+\s/gm, '')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
          ...
          {/* Grand Prize section hidden — will be revealed as a surprise later */}
      ...
      {/* Connection Status Footer -- insights moved to SleepInsights.tsx */}
      {!isOnline && (
